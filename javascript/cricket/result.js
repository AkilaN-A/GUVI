var rest = JSON.parse(window.localStorage.getItem('user'));
var tto = window.localStorage.getItem('indtotal');
var balls1 = window.localStorage.getItem('indballs');
create_table(rest,tto,"myTable",balls1);
var rest1 = JSON.parse(window.localStorage.getItem('user1'));
var tto1= window.localStorage.getItem('austotal');
var balls2 = window.localStorage.getItem('ausballs');
...
for(var i in rest){
    ...
    for(var j in val){
		...
		var cell4 = row.insertCell(3);
		 ...
		 cell4.innerHTML = (cell2.innerHTML/cell3.innerHTML).toFixed(2);
			}
